...
\author{																																														% Line 3
     Hongyuan Jia\textsuperscript{1} ,  Baisong Ning\textsuperscript{2} \\
  \parbox{\linewidth}{\centering%
     \textsuperscript{1}Chongqing University of Science and Technology, Chongqing, 401331, People's Republic of China \\ \textsuperscript{2}Zhengzhou University, Zhengzhou, Henan Province, 450001, People's Republic of China \\
  }
  \phantom{Line 8}\\
  \phantom{Line 9}
  } 																																									% Line 9
...
Sustainability in the Tropics (SinBerBEST) Program and thank Prof.~Adrian Chong
(National University of Singapore) for his scientific input during epwshiftr
development.
