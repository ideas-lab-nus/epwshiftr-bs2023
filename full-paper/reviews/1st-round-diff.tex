...
%DIF DEL full-paper/paper-oldtmp-28324.tex   Fri Jun 30 06:54:40 2023
%DIF ADD full-paper/paper-newtmp-28324.tex   Fri Jun 30 06:54:40 2023
...
%DIFDELCMD < \includegraphics[width=\columnwidth]{figures/ssp} %%%
...
\DIFdelbegin %DIFDELCMD < \includegraphics[width=\columnwidth]{figures/code-install.png}
...
\DIFdelbegin %DIFDELCMD < \begin{figure}
%DIFDELCMD < \includegraphics[width=\columnwidth]{figures/workflow} %%%
\DIFdelendFL \DIFaddbeginFL \begin{figure*}
...
\DIFdelbegin %DIFDELCMD < \includegraphics[width=\columnwidth]{figures/code-index.png}
%DIFDELCMD < \end{listing}
%DIFDELCMD < %%%
\DIFdelend 
...
\DIFdelbegin %DIFDELCMD < \includegraphics[width=\columnwidth]{figures/code-db.png}
%DIFDELCMD < \end{listing}
%DIFDELCMD < %%%
\DIFdelend 
...
%DIFDELCMD < \includegraphics[width=\columnwidth]{figures/code-data.png}
%DIFDELCMD < \end{listing}
%DIFDELCMD < 
...
\DIFdelbegin %DIFDELCMD < \includegraphics[width=\columnwidth]{figures/code-epw.png}
%DIFDELCMD < \end{listing}
%DIFDELCMD < %%%
\DIFdelend 
